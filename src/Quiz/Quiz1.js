        ...
        <div className='quize_main_box'>
            ...
            <div className='left_section'>
                <div className='question_box'>
                    <div className='question_img p-0'>
                    ...
                    <div className='question_'>
                        <p className=''>Identify the person in the picture</p>
                    </div>
                </div>
    ...
    const steps = [
        {
            ...
            options: [{ name: 'Jim Carrey', isTrue: false }, { name: 'Emma Watson', isTrue: true }, { name: 'Robert Downey', isTrue: false }, { name: 'Chris Evans', isTrue: false }],
