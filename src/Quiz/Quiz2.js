            ...
            <div className='left_section'>
                <div className='question_box'>
                    <div className='question_img'>
                        ...
                        <p className='question'>What is the capital city of Japan?</p>
                    </div>
    ...
    const steps = [
        {
            ...
            options: [{ name: 'Beijing', isTrue: false }, { name: 'Tokyo', isTrue: true }, { name: 'Seoul', isTrue: false }, { name: 'Bangkok', isTrue: false }],
