            ...
            <div className='left_section'>
                <div className='question_box'>
                    <div className='question_img'>
                        ...
                        <p className='question'>What is the value of sin^2(𝑥)+cos^2(𝑥), where x is any angle?</p>
                    </div>
...
export default function Quiz4() {
    ...
    const steps = [
        {
            id: 1,
            question: 'What is the value of sin^2(𝑥)+cos^2(𝑥), where x is any angle?',
            options: [{ name: '1', isTrue: true }, { name: '0', isTrue: false }, { name: '2', isTrue: false }, { name: '1/2', isTrue: false }],
